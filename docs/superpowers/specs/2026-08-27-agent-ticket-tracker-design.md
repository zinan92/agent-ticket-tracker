...
- State source: a project-local JSON manifest plus readable local Markdown artifacts. The manifest records source type, freshness, node state, acceptance summaries, evidence references, blockers, and next actions.
